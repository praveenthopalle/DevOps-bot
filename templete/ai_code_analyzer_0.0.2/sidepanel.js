...
//     // let url = "http://8.218.90.105:8790/plugine/repo_analyzer?type=GitHub&repo=PKTAI/DevOpsGPT"
...
getAiContent = async () => {
    ...
    try {
        ...
        let url = "https://www.PKTAI.net/backend/plugine/repo_analyzer?type=GitHub&repo=" + repo_name;
        // console.log(url)
        let res = await $.get(url)
        ...
        if (res.success) {
            ...
            if (res.data.hasOwnProperty("error_code")) {
                if (res.data.error_code === 1001) {
                    ...
                    updateError(message + "  website:<a href=\"https://www.PKTAI.net\" target=\"_blank\">PKTAI</a>")
                } else {
                    updateError(message)
                }
